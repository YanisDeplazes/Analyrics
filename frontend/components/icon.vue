<template>
    <i
        :class="{ 'icon-large': size == 'large', 'icon-xl': size == 'xl', 'icon-primary': type == 'primary', 'icon-secondary': type == 'secondary' }">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" v-if="variant == 'niche'">
